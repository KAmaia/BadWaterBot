...
public class CreditsCommand implements Command<MessageEvent> {
	...
	public void exec(MessageEvent event) throws Exception {
		...
		b.sendIRC().notice(event.getUser().getNick(),
		                   "My Creator is Krystal.  " +
			                      "Also, My Mistress would like to thank everybody in #Reddit-GameDev, " +
			                      ...
			                      "Almighty Krystal, please send an email to krystalAmaia@gmail.com.  She may " +
			                      "or may not respond, at her leisure.  Thank you for Using "
